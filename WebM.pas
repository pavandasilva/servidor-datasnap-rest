...
begin
  Response.Content :=
    '<html>' +
    '<head><title>Servidor Rest</title></head>' +
    '<body>Servidor Rest</body>' +
    '</html>';
end;
...
begin
  //nao exiba a tag result no json
  ResultVal := (ResultVal as TJSONArray).Items[0];
  Handled := True;
end;
